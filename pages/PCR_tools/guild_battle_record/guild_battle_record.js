	...
	for (let i=0; i<actionData.length; i++) {
		...
		if (remainHealth <= 0) {
			...
			if (curBossIdx===mobData.length) {
				...
				mobData[curBossIdx+2] = {bossIdx: curBossIdx+3, health: 10000000, scoreFactor: 1.5, name: mobData[2].name, round: curBossIdx/5+1, bossNum: 3, bgC: "background: #c22"}
				mobData[curBossIdx+3] = {bossIdx: curBossIdx+4, health: 12000000, scoreFactor: 1.7, name: mobData[3].name, round: curBossIdx/5+1, bossNum: 4, bgC: "background: #922"}
				mobData[curBossIdx+4] = {bossIdx: curBossIdx+5, health: 20000000, scoreFactor: 2, name: mobData[4].name, round: curBossIdx/5+1, bossNum: 5, bgC: "background: #f22"}
			}
		}
