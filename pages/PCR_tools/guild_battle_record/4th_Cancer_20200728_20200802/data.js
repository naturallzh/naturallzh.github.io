...
const DATA_actionData = [
	...
	},
	{
		...
		log: [
			...
			{name: "夜雨纷扬", damage: 783206, time: '2020,7,2,7,1'},
			{name: "红豆沙", damage: 835704, time: '2020,7,2,7,7'},
			{name: "好好先生", damage: 1000349, time: '2020,7,2,7,17'},
			{name: "橙子", damage: 861559, time: '2020,7,2,7,42'},
			{name: "红豆沙", damage: 648491, time: '2020,7,2,7,46'},
		]
	},
	{
		day: 6,
		bossIdx: 39,
		log: [
			{name: "红豆沙", damage: 253019, time: '2020,7,2,7,49'},
			{name: "黑椿", damage: 1241118, time: '2020,7,2,7,56'},
			{name: "常磐丁香", damage: 1255012, time: '2020,7,2,7,57'},
			{name: "灼眼的Saber", damage: 1059385, time: '2020,7,2,8,10'},
			{name: "橙子", damage: 922850, time: '2020,7,2,8,10'},
			{name: "何等的寂寞", damage: 723266, time: '2020,7,2,8,30'},
			{name: "好好先生", damage: 950034, time: '2020,7,2,8,39'},
			{name: "风月", damage: 983238, time: '2020,7,2,8,55'},
			{name: "风月", damage: 988735, time: '2020,7,2,8,59'},
			{name: "长星夜烁", damage: 1054284, time: '2020,7,2,9,2'},
			{name: "长星夜烁", damage: 1149165, time: '2020,7,2,9,8'},
			{name: "lala", damage: 726284, time: '2020,7,2,9,12'},
			{name: "一起学猫叫", damage: 693610, time: '2020,7,2,9,24'},
		]
	},
	{
		day: 6,
		bossIdx: 40,
		log: [
			{name: "一起学猫叫", damage: 169433, time: '2020,7,2,9,25'},
			{name: "宋寂", damage: 524494, time: '2020,7,2,9,27'},
			{name: "池霜", damage: 538932, time: '2020,7,2,9,30'},
			{name: "以摸多", damage: 498658, time: '2020,7,2,9,34'},
			{name: "常磐丁香", damage: 565760, time: '2020,7,2,9,34'},
			{name: "长星夜烁", damage: 504681, time: '2020,7,2,9,38'},
			{name: "八云蓝", damage: 506115, time: '2020,7,2,9,40'},
			{name: "好好先生", damage: 541480, time: '2020,7,2,9,43'},
			{name: "魂魄妖梦", damage: 496480, time: '2020,7,2,9,47'},
		]
	}
];
