...
const DATA_actionData = [
	// D1
	{
		...
		bossIdx: 1,
		log: [
			{name: "何等的寂寞", damage: 1207045, time: '2020,6,27,5,35'},
			{name: "以摸多", damage: 941615, time: '2020,6,27,7,7'},
			{name: "打个大西瓜", damage: 1066506, time: '2020,6,27,7,23'},
			{name: "keiko", damage: 999675, time: '2020,6,27,9,1'},
			{name: "坑神", damage: 1075762, time: '2020,6,27,9,34'},
			{name: "keiko", damage: 1098568, time: '2020,6,27,9,34'},
		]
	},
	{
		day: 1,
		bossIdx: 2,
		log: [
			{name: "好好先生", damage: 1043597, time: '2020,6,27,9,41'},
			{name: "坑神", damage: 458147, time: '2020,6,27,9,41'},
			{name: "八云蓝", damage: 1018826, time: '2020,6,27,9,43'},
			{name: "金色之泪", damage: 1021572, time: '2020,6,27,9,44'},
			{name: "福尔康", damage: 996212, time: '2020,6,27,9,44'},
			{name: "Otaku", damage: 964780, time: '2020,6,27,10,12'},
			{name: "何等的寂寞", damage: 1010676, time: '2020,6,27,10,38'},
			{name: "初心如故", damage: 1036626, time: '2020,6,27,12,21'},
			{name: "我群最菜", damage: 1007968, time: '2020,6,27,12,21'},
		]
	},
	{
		day: 1,
		bossIdx: 3,
		log: [
			{name: "风月", damage: 1000518, time: '2020,6,27,12,27'},
			{name: "keiko", damage: 723730, time: '2020,6,27,12,34'},
			{name: "灼眼的Saber", damage: 990674, time: '2020,6,27,12,35'},
			{name: "我群最菜", damage: 565828, time: '2020,6,27,12,35'},
			{name: "宋寂", damage: 767649, time: '2020,6,27,12,40'},
			{name: "戏言君", damage: 996437, time: '2020,6,27,13,15'},
			{name: "一起学猫叫", damage: 810733, time: '2020,6,27,14,7'},
			{name: "好好先生", damage: 1070270, time: '2020,6,27,15,7'},
			{name: "初心如故", damage: 985761, time: '2020,6,27,15,24'},
			{name: "福尔康", damage: 888276, time: '2020,6,27,15,25'},
			{name: "风月", damage: 701249, time: '2020,6,27,16,30'},
			{name: "风月", damage: 498875, time: '2020,6,27,16,30'},
		]
	},
];
