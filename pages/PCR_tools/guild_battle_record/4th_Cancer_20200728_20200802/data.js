...
const DATA_actionData = [
	...
	},
	{
		...
		log: [
			...
			{name: "常磐丁香", damage: 1048312, time: '2020,7,2,17,36'},
			{name: "香浓朱古力", damage: 1141866, time: '2020,7,2,17,45'},
			{name: "池霜", damage: 1053091, time: '2020,7,2,17,48'},
			{name: "我群最菜", damage: 1087254, time: '2020,7,2,17,48'},
			{name: "幽蓝", damage: 1126911, time: '2020,7,2,17,49'},
			{name: "打个大西瓜", damage: 446938, time: '2020,7,2,17,53'},
		]
	},
	{
		day: 6,
		bossIdx: 37,
		log: [
			{name: "打个大西瓜", damage: 362443, time: '2020,7,2,17,55'},
			{name: "金色之泪", damage: 1178461, time: '2020,7,2,17,58'},
			{name: "我群最菜", damage: 1154479, time: '2020,7,2,17,59'},
			{name: "幽蓝", damage: 1187996, time: '2020,7,2,17,59'},
			{name: "夜雨纷扬", damage: 1263744, time: '2020,7,2,18,4'},
			{name: "初心如故", damage: 1173101, time: '2020,7,2,18,6'},
			{name: "池霜", damage: 1171678, time: '2020,7,2,18,6'},
			{name: "初心如故", damage: 508098, time: '2020,7,2,18,13'},
		]
	},
	{
		day: 6,
		bossIdx: 38,
		log: [
			{name: "初心如故", damage: 328732, time: '2020,7,2,18,16'},
			{name: "香浓朱古力", damage: 846955, time: '2020,7,2,18,21'},
			{name: "福尔康", damage: 846955, time: '2020,7,2,18,23'},
			{name: "黑椿", damage: 800561, time: '2020,7,2,18,25'},
			{name: "金色之泪", damage: 872179, time: '2020,7,2,18,31'},
			{name: "打个大西瓜", damage: 701924, time: '2020,7,2,18,37'},
			{name: "lala", damage: 768495, time: '2020,7,2,18,54'},
			{name: "宋寂", damage: 790353, time: '2020,7,2,18,56'},
			{name: "夜雨纷扬", damage: 783206, time: '2020,7,2,19,1'},
			{name: "红豆沙", damage: 835704, time: '2020,7,2,19,7'},
			{name: "好好先生", damage: 1000349, time: '2020,7,2,19,17'},
			{name: "橙子", damage: 861559, time: '2020,7,2,19,42'},
			{name: "红豆沙", damage: 648491, time: '2020,7,2,19,46'},
		]
	},
	{
		day: 6,
		bossIdx: 39,
		log: [
			{name: "红豆沙", damage: 253019, time: '2020,7,2,19,49'},
			{name: "黑椿", damage: 1241118, time: '2020,7,2,19,56'},
			{name: "常磐丁香", damage: 1255012, time: '2020,7,2,19,57'},
			{name: "灼眼的Saber", damage: 1059385, time: '2020,7,2,20,10'},
			{name: "橙子", damage: 922850, time: '2020,7,2,20,10'},
			{name: "何等的寂寞", damage: 723266, time: '2020,7,2,20,30'},
			{name: "好好先生", damage: 950034, time: '2020,7,2,20,39'},
			{name: "风月", damage: 983238, time: '2020,7,2,20,55'},
			{name: "风月", damage: 988735, time: '2020,7,2,20,59'},
			{name: "长星夜烁", damage: 1054284, time: '2020,7,2,21,2'},
			{name: "长星夜烁", damage: 1149165, time: '2020,7,2,21,8'},
			{name: "lala", damage: 726284, time: '2020,7,2,21,12'},
			{name: "一起学猫叫", damage: 693610, time: '2020,7,2,21,24'},
		]
	},
	{
		day: 6,
		bossIdx: 40,
		log: [
			{name: "一起学猫叫", damage: 169433, time: '2020,7,2,21,25'},
			{name: "宋寂", damage: 524494, time: '2020,7,2,21,27'},
			{name: "池霜", damage: 538932, time: '2020,7,2,21,30'},
			{name: "以摸多", damage: 498658, time: '2020,7,2,21,34'},
			{name: "常磐丁香", damage: 565760, time: '2020,7,2,21,34'},
			{name: "长星夜烁", damage: 504681, time: '2020,7,2,21,38'},
			{name: "八云蓝", damage: 506115, time: '2020,7,2,21,40'},
			{name: "好好先生", damage: 541480, time: '2020,7,2,21,43'},
			{name: "魂魄妖梦", damage: 496480, time: '2020,7,2,21,47'},
			{name: "风月", damage: 584191, time: '2020,7,2,21,53'},
			{name: "keiko", damage: 544675, time: '2020,7,2,23,36'},
			{name: "keiko", damage: 457933, time: '2020,7,2,23,51'},
		]
	}
];
